...
function setupAdvancedForm() {
    ...
    // Submissão do formulário - Compatível com Netlify
    form.addEventListener('submit', function(e) {
        ...
        // Se estiver no Netlify (produção), deixar o envio nativo
        if (window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1') {
            // Mostrar loading
            submitBtn.classList.add('loading');
            
            // Não prevenir o envio - deixar o Netlify processar
            // Adicionar timeout para mostrar feedback visual
            setTimeout(() => {
        ...
        // Para desenvolvimento local, prevenir e simular
        e.preventDefault();
        submitBtn.classList.add('loading');
